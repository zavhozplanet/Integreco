...
let glDefaults={shape:'straight',dash:'solid',width:1.5,dir:'forward',color:null, style: { fontFamily: 'Inter, sans-serif', fontWeight: 'normal', fontStyle: 'normal', fontSize: 13, textAlign: 'center', color: null }, defaultFlags: { variant: false, size: false, color: false }};
let linkDefaults={shape:'straight',dash:'link',width:1,dir:'none',color:null, style: { fontFamily: 'Inter, sans-serif', fontWeight: 'normal', fontStyle: 'normal', fontSize: 13, textAlign: 'center', color: null }, defaultFlags: { variant: false, size: false, color: false }};
let noteDefaults = {
